...
import { NightComic } from "../sources/NightComic/NightComic";

describe('Night Comic Tests', function () {

    var wrapper: APIWrapper = new APIWrapper();
    var source: Source = new NightComic(cheerio);
    ...
    it("Get Chapter Details", async () => {
        ...
        console.log(`MangaID: ${data.mangaId}`)
    ...
    it("Testing search", async () => {
        ...
        console.log(`Subtitle Text: ${result.subtitleText}`)
