...
export class NHentaiRedirected extends Source {
  ...
  get description(): string { return 'nHentai source which is guarinteed to work in countries the website is normally blocked. May be a tad slower than the other source' }
